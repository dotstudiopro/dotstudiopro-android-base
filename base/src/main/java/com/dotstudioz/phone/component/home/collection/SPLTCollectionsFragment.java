package com.dotstudioz.phone.component.home.collection;
...
public class SPLTCollectionsFragment extends SPLTBaseFragment {
    ...
    public SPLTCollectionsFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static SPLTCollectionsFragment newInstance(String param1, String param2) {
        SPLTCollectionsFragment fragment = new SPLTCollectionsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //return inflater.inflate(R.layout.fragment_splt_categories, container, false);
    ...
    public void onCreateOptionsMenuDS(Menu menu, MenuInflater inflater){
    }
    ...
    public void reloadUI(){
        Log.d(TAG, "onViewCreated: "+mCategoryList.size());
        if(recyclerView != null){
            recyclerView.setLayoutManager(new GridLayoutManager(getActivity(), numberOfColumns));
            categoryAdapter = new SPLTCategoryAdapter(getActivity(), mCategoryList, cardViewHeight, cardViewwidth);
